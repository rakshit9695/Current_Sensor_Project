"""
milling/ml/trainer.py
=========================
Training loop, multi-task loss, and checkpoint management for the Milling Machine.
...
Checkpoint saved to:  milling/ml/checkpoints/model.pt
"""
...
from .dataset import MillingDataset, NormStats
...
def train(
    train_ds:   MillingDataset,
    val_ds:     MillingDataset,
